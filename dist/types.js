System.register("assert/src/assert", [], function() {
  "use strict";
  var __moduleName = "assert/src/assert";
...
var assert = System.get("assert/src/assert").assert;
var TypeTest = function TypeTest(x, y) {
  "use strict";
  assert.argumentTypes(x, $traceurRuntime.type.string, y, $traceurRuntime.type.number);
  this.x = x;
  this.y = y;
};
($traceurRuntime.createClass)(TypeTest, {}, {});
TypeTest.parameters = [[$traceurRuntime.type.string], [$traceurRuntime.type.number]];
new TypeTest(1, "hoge");
